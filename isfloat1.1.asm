;****************************************************************************************************************************
;Program name: "isfloat1.1".  This a library function contained in a single file.  The function receives a null-terminated     *
...
;
;Modified by Isaiah Vogt
;  email: ivogt@csu.fullerton.edu
;  phone: (909)631-7185
;
;Status
...
;
;Modifications
;  This function was modified by Isaiah Vogt for use in the program, "Triangle Trigonometry I/O." The modifications
;  ensure that the program will return an error message if negative values are inputted.
;
...
;******************************* Modification Begins *******************************
; The modifications below ensures that when a byte of the inputted data with the character '-' returns an error.
cmp byte[r13],'-'
je return_false
